...
public class GetCommand {
    ...
    static ArgumentBuilder<CommandSourceStack, ?> register() {
        return Commands.literal("get").then(Commands.argument("player", EntityArgument.player()).then(Commands.argument("skill", EnumArgument.enumArgument(Skill.class)).executes(GetCommand::execute)));
    }
                                                ...
                                                Commands.argument("player", EntityArgument.player())  // "player" 参数
                                                        .then(
                                                                Commands.argument("skill", EnumArgument.enumArgument(Skill.class))  // "skill" 参数
                                                                        .executes(GetCommand::execute)  // 执行 GetCommand.execute 方法
                                                        )
                                        )
                        )
                        .then(
